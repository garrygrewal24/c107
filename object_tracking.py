...
video = cv2.VideoCapture("C:/Users/DELL/Downloads/PRO-C107-Student-Boilerplate-main/PRO-C107-Student-Boilerplate-main/bb3.mp4")
...
def goal_track(img, bbox):
    ...
    if (dist<=20):
        cv2.putText(img,"goal",(300,90),cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,0.7,(0,255,0),2)
